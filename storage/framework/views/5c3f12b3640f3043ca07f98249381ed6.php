<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9 landing-dark-bg faz-bg-image">
    ...
    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20 d-flex flex-column justify-content-center align-items-center width-responsive">
        <img src="<?php echo e(asset('assets/book-title.svg?v=2')); ?>" class="w-lg-600px w-md-600px w-325px mb-10 mt-20" alt="">
        <h1 class="text-white mb-20"><?php echo e(__('Beta')); ?></h1>
        

        <form id="search-form" action="<?php echo e(route("search.lessons")); ?>" method="GET" class="d-flex flex-column flex-md-row">
        ...
        <div class="d-flex gap-10 justify-content-center align-items-center mt-20 margin-sm-top p-5">
            <a href="<?php echo e(route('subjects.index')); ?>" class="btn btn-primary"><?php echo e(__('Start Learning')); ?>

                <i class="fas fa-graduation-cap fs-4 ms-2"></i>
            </a>
            <a href="<?php echo e(route('download')); ?>" class="btn btn-danger"><?php echo e(__('Download Book')); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/resources/views/front/includes/hero.blade.php ENDPATH**/ ?>