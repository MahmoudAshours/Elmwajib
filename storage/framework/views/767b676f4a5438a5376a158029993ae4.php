        ...
        <?php $__currentLoopData = $sponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($sponsor->url): ?>
                <a href="<?php echo e($sponsor->url); ?>" target="_blank">
                    <img data-u="image" class="object-contain" src="<?php echo e($sponsor->thumbnail_url); ?>"/>
                </a>
            <?php else: ?>
                <div>
                    <img data-u="image" class="object-contain" src="<?php echo e($sponsor->thumbnail_url); ?>"/>
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('template/assets/plugins/custom/logo-slider/js/jssor.slider-28.1.0.min.js')); ?>"
...
<?php $__env->stopPush(); ?>
<?php /**PATH /var/www/html/resources/views/components/sponsors-slider.blade.php ENDPATH**/ ?>