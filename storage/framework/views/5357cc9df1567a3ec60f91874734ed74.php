                    ...
                    <div class="card-body d-flex justify-content-center text-center flex-column gap-5">
                        ...
                        <div class="d-flex flex-column text-center justify-content-center align-items-center gap-3">
                            <div class="fs-1 on-hover-text-white">
                                <?php echo e(__('Teacher Book')); ?>

                            </div>
                        </div>
                        <div>
                            <a href="<?php echo e(route('download_book' , 'teacher')); ?>"
            ...
            <div class="col-lg-4">
                <div class="card h-100 shadow-sm card-hover card-hover-success">
                    <div class="card-body  d-flex justify-content-center text-center flex-column gap-5">
                        ...
                        <div class="d-flex flex-column text-center justify-content-center align-items-center gap-3">
                            <div class="fs-1 on-hover-text-white">
                                <?php echo e(__('Student Book')); ?>

                            </div>
                        </div>
                        <div class="mt-5">
                            <a href="<?php echo e(route('download_book' , 'student')); ?>"
...
<?php echo $__env->make('front.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/front/pages/download-book.blade.php ENDPATH**/ ?>